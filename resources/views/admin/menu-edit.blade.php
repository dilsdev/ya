<div>
    <form wire:submit="update" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="deskripsi" id="deskripsi" aria-describedby="deskripsi"
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="jenis" id="jenis" wire:model="jenis">
